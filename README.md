...
Please refer to [How to Run Tesseract OCR + pytesseract in AWS Lambda Container Images](https://wasabee.dev/2022/06/how-to-run-tesseract-ocr-with-pytesseract-in-lambda-container-images/) for more details.
